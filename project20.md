...
- Run the Tooling app
  ...
  - Run the container
    ```
    docker run --network tooling_app_network -p 8086:80 -it tooling:0.0.1
    ```
    ![](imgs/tooling.png)
    ![](imgs/website.png)
...
Link to php-todo repo: https://github.com/ekwutosi/php-todo-app
Destroy all AWS resource to avoid unwanted spending